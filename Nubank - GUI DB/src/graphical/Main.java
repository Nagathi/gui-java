...
public class Main{
	...
	private void initialize(){
		...
		jdbc.connectDB();
		ContasDAO jdbcContas = new ContasDAO();
		lista_contas = jdbcContas.listar_conta();
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(checkCorrente.isSelected() && checkPoupanca.isSelected()) {
							...
							if(checkCorrente.isSelected() && autorizar) {
								Conta cc = new Corrente(nome, ano, cpf, user, pass);
								lista_contas.add(cc);
								ContasDAO cdb = new ContasDAO();
								cdb.cadastrar_conta(cc);
								...
								Conta cp = new Poupanca(nome, ano, cpf, user, pass);
								lista_contas.add(cp);
								ContasDAO cdb = new ContasDAO();
								cdb.cadastrar_conta(cp);
								JOptionPane.showMessageDialog(null, "Conta cadastrada!");
	...
	public void sacar() {
		...
		Iterator<Conta> it = lista_contas.iterator();
		boolean verify = false;
